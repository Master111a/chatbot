...
function darkMode(el) {
  ...
  const el = document.querySelector('.fixed-plugin .active');

  // Xác định mode từ data-class
  let mode = el && el.getAttribute && el.getAttribute('data-class') === 'bg-default' ? 'dark' : 'light';
  setThemeCookie(mode);
  ...
  let btnLight = document.querySelector('[data-class="bg-white"]');
  let btnDark = document.querySelector('[data-class="bg-default"]');
  if (btnLight && btnDark) {
...
document.addEventListener('DOMContentLoaded', function() {
  let theme = getThemeCookie() || 'light';
  let btn = null;
  if (theme === 'dark') {
    btn = document.querySelector('[data-class="bg-default"]');
  } else {
    btn = document.querySelector('[data-class="bg-white"]');
  }
  if (btn) darkMode(btn);
});